...
viewports.forEach((vp)=>{
    describe(`registroWrongPath:${vp}`,()=>{
        ...
        it('sinDatos',()=>{
            ...
            .contains('Completa este campo').should('be.visible')
            ...
            .contains('Utiliza un formato que coincida con el solicitado').should('be.visible')
        })
        it('dniIncompleto',()=>{
        ...
        it('fechaInvalida',()=>{
            ...
            cy.get('[data-slot="error-message"]')
            .contains('El valor debe ser').should('be.visible')
        })
        it('sinArroba',()=>{
        ...
        it('sinTextoPostArroba',()=>{
            cy.get('[data-cy="input-email"]').type('asd@').blur()
            cy.get('[data-slot="error-message"]')
            .should('include.text','Introduce texto detrás del signo "@". La dirección')
        })
        ...
        it('puntoPostArroba',()=>{
            ...
            cy.get('[data-slot="error-message"]')
            .should('include.text','El signo "." está colocado en una posición incorrecta en la dirección')
        })
        it('correoInvalido',()=>{
